...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with finite turns were not properly decremented and re-enqueued.
    ...
    // Defect(s) Found: Person added mid-way was not processed correctly or skipped.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: nfinite-turn users with 0 were not re-enqueued.
    ...
    // Defect(s) Found: Negative turns also represent infinite, but were removed or decremented.
    ...
    // Defect(s) Found: No exception was thrown when calling GetNextPerson on an empty queue.
